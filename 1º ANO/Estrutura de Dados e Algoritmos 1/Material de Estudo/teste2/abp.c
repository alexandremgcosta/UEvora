...
int main()
{
    BTree T = CreateTree(13);
    T->Left = SetTree(10, SetTree(6, NULL, NULL), NULL);
    T->Right = SetTree(15, SetTree(14, NULL, NULL), SetTree(31, SetTree(19, NULL, NULL), SetTree(40, SetTree(34, NULL, NULL), NULL)));
